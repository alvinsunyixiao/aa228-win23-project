...
class MPC:
    def __init__(self, world, agent_idx, dest, gamma=0.95):
        self.world = world
        ...
        self.m = 1
        self.gamma = gamma
        self.roll_out_policy_decay = 0.92
...
if __name__ == "__main__":
    ...
    controller1 = MPC(w, 1, np.array([50, 20]))
    for i in range(50):
